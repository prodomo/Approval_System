...
<div>
    ...
    <div class="box-body">
        <table class="table table-bordered">
            <tbody>
            <tr><th colspan="8">本文，依據{{lastApprovalID}}辦理</th></tr>
            <tr scope="row">
                <td>簽呈號</td>
                <td colspan="3">
            ...
            <tr scope="row" class="table-warning">
                <td colspan="8">
                     <label>承辦人員  {{person}}  目前狀態 {{state}}</label>
                </td>
            </tr>
            <tr scope="row" class="table-warning">
                <td colspan="8">
                     <label>單位主管  {{person}}  目前狀態 {{state}}</label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td colspan="7">
                    <label><input type="checkbox">送會其他單位</label>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="7">
                    <label><input type="checkbox">如需『發文』或『公告』，請勾選，並上傳檔案(請注意：單一檔案大小限制為5MB。)</label>
                </td>
            </tr>
            ...
            <btn class="btn btn-primary" to="/03">預覽</btn>
            <btn class="btn btn-primary" >作廢</btn>
            </td></tr>
        </table>
        <btn class="btn btn-primary" >列印</btn>
        <btn class="btn btn-primary" >主選單</btn>
        <btn  class="btn btn-primary" to="/01">回上一頁</btn>
    </div>
</div>
</template>
...
export default {
    ...
    methods:{
        Date(){
            var date = Date.now();
            return date.Date.prototype.toString();
        }
    }
